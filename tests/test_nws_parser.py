...
from wxdxx.api.nws import NWSClient


class TestUGCExpiryParsing:
    """Tests for _parse_ugc_expiry() method."""

    @pytest.fixture
    def client(self):
        """Create NWS client instance for testing."""
        return NWSClient()

    def test_parse_single_line_ugc(self, client):
...
"""
        ...
        with patch("wxdxx.api.nws.datetime") as mock_dt:
            mock_dt.now.return_value = datetime(2025, 12, 26, 12, 0, tzinfo=timezone.utc)
            mock_dt.side_effect = lambda *args, **kw: datetime(*args, **kw)
            result = client._parse_ugc_expiry(text)
    ...
    def test_parse_multi_zone_ugc(self, client):
...
"""
    ...
    def test_parse_multi_line_ugc(self, client):
...
"""
    ...
    def test_parse_expired_product_same_month(self, client):
...
"""
    ...
    def test_parse_previous_month_rollback(self, client):
...
"""
    ...
    def test_parse_empty_text(self, client):
        ...
        assert client._parse_ugc_expiry("") is None
        assert client._parse_ugc_expiry(None) is None

    def test_parse_no_ugc_header(self, client):
...
"""
    ...
    def test_parse_malformed_ugc(self, client):
...
"""
    ...
    def test_parse_invalid_time(self, client):
...
"""
    ...
    def test_parse_real_sps_format(self, client):
