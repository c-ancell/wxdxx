...
# Names kept short but recognizable (no obscure airport codes)
MAJOR_CITIES: list[tuple[float, float, str]] = [
    ...
    (-98.4936, 29.4241, "San Ant"),
    (-97.7431, 30.2672, "Austin"),
    (-101.8313, 35.2220, "Amarillo"),
    (-94.5786, 39.0997, "KC"),
    (-90.1994, 38.6270, "St Louis"),
    (-89.6501, 39.7817, "Sprngfld"),
    (-93.6250, 41.5868, "Des Moin"),
    (-96.7898, 43.5460, "Sioux Fl"),
    (-100.7837, 46.8083, "Bismarck"),
    (-96.8005, 46.8772, "Fargo"),
    (-97.4395, 35.2226, "Norman"),
    # Southeast
    (-84.3880, 33.7490, "Atlanta"),
    (-86.7816, 36.1627, "Nashvlle"),
    (-90.0490, 35.1495, "Memphis"),
    (-86.8025, 33.5207, "B'ham"),
    (-81.6557, 30.3322, "Jax"),
    (-80.1918, 25.7617, "Miami"),
    (-82.4572, 27.9506, "Tampa"),
    (-81.3792, 28.5383, "Orlando"),
    (-78.6382, 35.7796, "Raleigh"),
    (-80.8431, 35.2271, "Charltte"),
    (-79.9311, 32.7765, "Chrlston"),
    (-84.2807, 30.4383, "Tallhsse"),
    (-88.0399, 30.6954, "Mobile"),
    (-90.0715, 29.9511, "N Orlns"),
    (-91.1871, 30.4515, "Btn Rge"),
    # Midwest
    (-87.6298, 41.8781, "Chicago"),
    (-83.0458, 42.3314, "Detroit"),
    (-81.6944, 41.4993, "Clevelnd"),
    (-84.5120, 39.1031, "Cincy"),
    (-85.7585, 38.2527, "Louisvle"),
    (-86.1581, 39.7684, "Indpls"),
    (-89.4012, 43.0731, "Madison"),
    (-87.9065, 43.0389, "Milwke"),
    (-93.2650, 44.9778, "Mpls"),
    # Northeast
    (-73.9857, 40.7484, "NYC"),
    (-71.0589, 42.3601, "Boston"),
    (-75.1652, 39.9526, "Philly"),
    (-76.6122, 39.2904, "Bltmore"),
    (-77.0369, 38.9072, "DC"),
    (-79.9959, 40.4406, "Pitt"),
    # Mountain/West
    (-104.9903, 39.7392, "Denver"),
    (-105.2705, 40.0150, "Boulder"),
    (-104.8214, 38.8339, "Co Spgs"),
    (-111.8910, 40.7608, "SLC"),
    (-106.6504, 35.0844, "Albuq"),
    ...
    (-122.4194, 37.7749, "SF"),
    (-118.2437, 34.0522, "LA"),
    (-117.1611, 32.7157, "San Dgo"),
    (-121.4944, 38.5816, "Sacrmto"),
